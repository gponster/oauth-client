...
class SessionStorage implements TokenStorageInterface {
	 ...
	 *        	Whether or not to start the session upon construction.
	 * @param string $sessionVariableName
	 *        	the variable name to use within the _SESSION superglobal
	 */
	...
	public function hasAccessToken($service) {
		return isset($_SESSION[$this->sessionVariableName],
			$_SESSION[$this->sessionVariableName][$service]);
	}
